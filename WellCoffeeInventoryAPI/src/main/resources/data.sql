...
(1, 1, 23, 5.99, 55, "Espresso Beans", "", "Astute comment", "Dark and tasty", "Shelf 1A", ""),
(1, 2, 12, 12.99, 10, "Highlander Grog Beans", "", "Astute comment", "There can only be one...", "Shelf 1A", ""),
(1, 3, 13, 15.99, 8, "Hazelnut Beans", "", "Astute comment", "Robust with a nutty finish.", "Shelf 1A", ""),
(2, 4, 14, 15.99, 15, "Cinnamon Rolls", "", "Astute comment", "A sweet staple.", "Shelf 2A", ""),
(2, 5, 15, 24.99, 18, "Strawberry Scones", "", "Astute comment", "There is fruit in it so it HAS to be healthy", "Shelf 2A", ""),
(3, 6, 16, 24.99, 20, "Straws", "", "Astute comment", "500 count", "Shelf 3A", ""),
(3, 7, 17, 19.99, 30, "Spoons", "", "Astute comment", "300 count", "Shelf 3A", ""),
(4, 8, 18, 12.99, 4, "Clorox Wipes", "", "Astute comment", "Keep it clean", "Shelf 4A", ""),
(4, 9, 19, 20.99, 8, "Light Bulbs", "", "Astute comment", "Keep it bright", "Shelf 4A", "");
