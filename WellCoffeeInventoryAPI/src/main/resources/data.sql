...
VALUES
-- Fields:
-- (category_id, id, minQuantity, price, quantity, name, amazonProductId, description, location)
...
(2, 5, 15, 24.99, 18, "Strawberry Scones", "", "There is fruit in it so it HAS to be healthy",
"Shelf
2A"),
